...
if ( ! class_exists( 'restaurant_food_delivery_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class restaurant_food_delivery_WPTT_WebFont_Loader {
		 ...
		 * @var string
		 */
		protected $restaurant_food_delivery_css;
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new restaurant_food_delivery_WPTT_WebFont_Loader( $url );
